...
namespace Amy
{
  class OperationsUnsigned : IOperations
  {
    public static OperationsUnsigned I = new OperationsUnsigned();
    ...
    public void Add (Operand result, Operand left, Operand right)
    {
      ...
      result.Set(type, left.AsUnsigned + right.AsUnsigned, left.IsConst && right.IsConst);
    }
